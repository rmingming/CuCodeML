...
#ifdef CUDA
             j = ming2(noisy>2?frub:NULL,&lnL,CUDA_lfundG,NULL,x,xb, com.space,e,np);
#else
...
*/
   ...
   if(com.model && com.NSsites) { 
      if(com.model==NSbranch2) { /* branch-site models A & B */         /*NSbranch2:2 */
         com.ncatG=4;  K=3;
         if(com.NSsites==NSdiscrete)                               /*NSdiscrete:3 */            
